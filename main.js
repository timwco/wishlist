...
var author$project$Template$listItem = function (rec) {
	return A2(
		elm$html$Html$li,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href(rec.link)
							]),
						_List_fromArray(
							[
								elm$html$Html$text(rec.title)
							]))
					]))
			]));
};
...
var author$project$Template$block = function (list) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(elm$core$List$map, author$project$Template$listItem, list.items))
			]));
};
var author$project$Template$render = function (list) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(elm$core$List$map, author$project$Template$block, list));
};
var author$project$WishList$list = _List_fromArray(
	[
		{
